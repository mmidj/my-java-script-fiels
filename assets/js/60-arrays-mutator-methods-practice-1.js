...
— select all the buttons in the html file.
— create a loop that will reach out to all buttons and give them events
— create a function load the list items inside the list
— create a function to get random items
